...
export class Backend implements backendInterface {
    ...
    async getGameState(arg0: Principal): Promise<GameSave> {
    ...
    async getPlayerProfile(arg0: Principal): Promise<PlayerProfile> {
        if (this.processError) {
            try {
    ...
    async saveGameState(arg0: bigint, arg1: bigint, arg2: string, arg3: bigint, arg4: string, arg5: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveGameState(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateHighScore(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateHighScore(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
